...
export const CASE_STUDIES: CaseStudy[] = [
  {
    title: "Spendify",
    tagline: "AI-powered finance mobile app—public site & internal admin dashboard",
    image:
    ...
    tech: ["React", "Next.js", "TypeScript", "Tailwind CSS", "State management", "REST APIs"],
  },
  {
    title: "Sahara Farms",
    tagline: "Pan-African agri-capital markets platform—landing & early dashboard",
    image:
  ...
  {
    title: "RYD Learning",
    tagline: "AI-powered coding education—avatar-led learning, IDE & structured curriculum",
    image:
      "https://images.pexels.com/photos/4145153/pexels-photo-4145153.jpeg?auto=compress&cs=tinysrgb&w=800",
    url: "https://www.rydlearning.com/",
    overview:
    ...
    results: [
      "Flagship AI learning feature built and on track for launch, with avatar, curriculum, and IDE in place",
    ...
    tech: ["React", "TypeScript", "Structured curriculum", "Interactive IDE", "AI integration"],
  },
];
